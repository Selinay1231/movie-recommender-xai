            ...
            with col2:
                ...
                for explanation_type in st.session_state.explanation_order:
                    if explanation_type == "text":
                        st.markdown(" <h3>Textuelle Erklärung</b>", unsafe_allow_html=True)
                        ...
                        st.markdown("<h3>SHAP-Visualisierung</b>", unsafe_allow_html=True)
                        fig, ax = plt.subplots()
                        ...
                        st.markdown(" <h3>Vektorraum-Erklärung</b>", unsafe_allow_html=True)
                        from sklearn.decomposition import PCA
