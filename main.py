...
/* Headline (App-Titel, z. B. "MovieMate") */
h1 {
  font-weight: 800;
  letter-spacing: .3px;
  color: #111 !important;   /* immer schwarz, egal Darkmode */
}
...
.hero__content {
  ...
  text-align: center;
  padding: 0 24px;
  background: rgba(0,0,0,0.35); /* halbtransparenter Hintergrund für bessere Lesbarkeit */
}
.hero__title {
...
.card__title {
  ...
  font-size: 17px;
  font-weight: 700;
  color: #111 !important;  /* fix immer schwarz */
}
.card__explain {
  color: #374151 !important; /* fix immer dunkelgrau */
  line-height: 1.45;
  font-size: 15px;
}
.badge {
